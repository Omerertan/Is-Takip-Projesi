...
namespace YSKProje.ToDo.DataAccess.Concrete.EntityFrameworkCore.Repositories
{
    public class EfGorevRepository : EfGenericRepository<Gorev>, IGorevDal
    {
        public Gorev GetirAciliyetileId(int id)
        {
            ...
            return context.Gorevler.Include(I => I.Aciliyet).FirstOrDefault(I => I.Id == id && !I.Durum);
        }
        ...
        public List<Gorev> GetirTumTablolarla()
        {
            ...
            return context.Gorevler.Include(I => I.Aciliyet).Include(I => I.Raporlar).Include(I => I.AppUser)
                .Where(I => !I.Durum).OrderByDescending(I => I.OlusturulmaTarih).ToList();
        }
        ...
        public List<Gorev> GetirTumTablolarla(Expression<Func<Gorev, bool>> filter)
        {
            using var context = new TodoContext();
            return context.Gorevler.Include(I => I.Aciliyet).Include(I => I.Raporlar).Include(I => I.AppUser)
                .Where(filter).OrderByDescending(I => I.OlusturulmaTarih).ToList();
        }
        ...
        public int GetirGorevSayisiileTamamlanmayanileAppUserId(int id)
        {
            using var context = new TodoContext();
            return context.Gorevler.Count(I => I.AppUserId == id && !I.Durum);
        }
        ...
        {
            using var context = new TodoContext();
            return context.Gorevler.Count(I => !I.Durum && I.AppUserId == null);
        }
